  ...
  Future<void> _loadFastestTime() async {
    try {
      ...
      final results = await Future.wait([
        http.get(Uri.parse('$baseUrl/api/game/fastest-time/${widget.playerId}/memory_match/$_difficulty')),
        http.get(Uri.parse('$baseUrl/api/game/fastest-times/leaderboard?game_type=memory_match&difficulty=$_difficulty')),
      ]);
