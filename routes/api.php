...
// QUIZ QUESTIONS
// ==========================================
// UPDATED: Make yearLevel optional by providing two routes
Route::get('/quiz/questions/{category}/{difficulty}/{yearLevel}', [QuizController::class, 'getQuestions']);
Route::get('/quiz/questions/{category}/{difficulty}', [QuizController::class, 'getQuestionsWithoutYearLevel']);  // NEW!
